...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "payload"."enum_notes_section" AS ENUM('Ancient India', 'Medieval India', 'Modern India', 'World History');
  CREATE TYPE "payload"."enum_notes_paper" AS ENUM('1', '2');
  CREATE TYPE "payload"."enum_notes_status" AS ENUM('draft', 'published');
  CREATE TYPE "payload"."enum__notes_v_version_section" AS ENUM('Ancient India', 'Medieval India', 'Modern India', 'World History');
  ...
  CREATE TYPE "payload"."enum_articles_kind" AS ENUM('current-affairs', 'new-note');
  CREATE TYPE "payload"."enum_articles_status" AS ENUM('draft', 'published');
  CREATE TYPE "payload"."enum__articles_v_version_kind" AS ENUM('current-affairs', 'new-note');
  ...
  CREATE TABLE "payload"."notes" (
  	...
  	"title" varchar,
  	"slug" varchar,
  	"section" "payload"."enum_notes_section",
  ...
  CREATE TABLE "payload"."_notes_v" (
  	...
  	"version_section" "payload"."enum__notes_v_version_section",
  ...
  CREATE TABLE "payload"."articles" (
  	...
  	"title" varchar,
  	"slug" varchar,
  	"kind" "payload"."enum_articles_kind" DEFAULT 'new-note',
  	"excerpt" varchar,
  ...
  CREATE TABLE "payload"."_articles_v" (
  	...
  	"version_title" varchar,
  	"version_slug" varchar,
  	"version_kind" "payload"."enum__articles_v_version_kind" DEFAULT 'new-note',
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "payload"."enum_notes_section";
  DROP TYPE "payload"."enum_notes_paper";
  DROP TYPE "payload"."enum_notes_status";
  DROP TYPE "payload"."enum__notes_v_version_section";
