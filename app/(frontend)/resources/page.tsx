...
const CAT = {
  Ancient:  { color: 'var(--ancient-text)',  bg: 'var(--ancient-wash)',  border: 'color-mix(in srgb, var(--ancient-text) 70%, transparent)',  label: 'Ancient India' },
  Medieval: { color: 'var(--medieval-text)', bg: 'var(--medieval-wash)', border: 'color-mix(in srgb, var(--medieval-text) 70%, transparent)', label: 'Medieval India' },
  Modern:   { color: 'var(--modern-text)',   bg: 'var(--modern-wash)',   border: 'color-mix(in srgb, var(--modern-text) 70%, transparent)',   label: 'Modern India' },
  World:    { color: 'var(--world-text)',    bg: 'var(--world-wash)',    border: 'color-mix(in srgb, var(--world-text) 70%, transparent)',    label: 'World History' },
};
...
function BookCover({ title, color }: { title: string; color: string }) {
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: `color-mix(in srgb, ${color} 6%, transparent)`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0.6rem', gap: 8 }}>
      <div style={{ width: 34, height: 34, borderRadius: 7, background: `color-mix(in srgb, ${color} 13%, transparent)`, border: `1px solid color-mix(in srgb, ${color} 70%, transparent)`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.78rem', fontWeight: 700, color }}>{initials}</div>
    </div>
  );
}
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '0.28rem' }}>
                ...
                <div style={{ width: 22, height: 1, background: `color-mix(in srgb, ${meta.color} 27%, transparent)`, margin: '0.1rem 0 0.2rem' }} />
