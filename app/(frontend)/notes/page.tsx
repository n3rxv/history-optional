...
const SECTIONS = [
  ...
  { label: 'Modern India', slug: 'modern-india', section: 'Modern India', paper: 'Paper II', color: 'var(--blue, var(--accent))' },
  { label: 'World History', slug: 'world-history', section: 'World History', paper: 'Paper II', color: 'var(--blue, var(--accent))' },
];
            ...
            {allNotes.map(note => (
              <Link key={note.slug} href={`/notes/${note.slug}`} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  borderLeft: `3px solid ${note.paper === 1 ? 'var(--accent)' : 'var(--blue, var(--accent))'}`,
