...
export default function PYQPage() {
  const questions = pyqs.filter(q => q.section === 'Paper II - Modern India');
  ...
  const schema = {
    ...
    "@graph": [
      {
        "@type": "CollectionPage",
        "@id": "https://historyoptional.xyz/pyqs/modern-india#page",
        "url": "https://historyoptional.xyz/pyqs/modern-india",
        "name": "Modern India PYQs — UPSC History Optional",
        "description": questions.length + " Previous Year Questions on Modern India for UPSC History Optional",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Modern India", "item": "https://historyoptional.xyz/pyqs/modern-india" },
        ]
      }
    ]
  };
