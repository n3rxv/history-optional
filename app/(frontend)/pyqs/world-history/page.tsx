...
export const metadata: Metadata = {
  title: 'World History PYQs — UPSC History Optional Previous Year Questions',
  description: 'All UPSC History Optional Previous Year Questions on World History (Paper II) from 1979–2026.',
  alternates: { canonical: 'https://historyoptional.xyz/pyqs/world-history' },
};

export default function PYQPage() {
  const questions = pyqs.filter(q => q.section === 'Paper II - World History');
  ...
  const schema = {
    ...
    "@graph": [
      {
        "@type": "CollectionPage",
        "@id": "https://historyoptional.xyz/pyqs/world-history#page",
        "url": "https://historyoptional.xyz/pyqs/world-history",
        "name": "World History PYQs — UPSC History Optional",
        "description": questions.length + " Previous Year Questions on World History for UPSC History Optional",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "World History", "item": "https://historyoptional.xyz/pyqs/world-history" },
        ]
      }
    ]
  };
