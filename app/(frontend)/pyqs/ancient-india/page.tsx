...
export const metadata: Metadata = {
  ...
  description: 'All UPSC History Optional Previous Year Questions on Ancient India (Paper I) from 1979–2026. Covers Harappan Civilization, Vedic Period, Mauryas, Guptas, and more.',
