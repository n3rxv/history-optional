...
export const metadata: Metadata = {
  title: 'Medieval India PYQs — UPSC History Optional Previous Year Questions',
  description: 'All UPSC History Optional Previous Year Questions on Medieval India (Paper I) from 1979–2026.',
  alternates: { canonical: 'https://historyoptional.xyz/pyqs/medieval-india' },
};

export default function PYQPage() {
  const questions = pyqs.filter(q => q.section === 'Paper I - Medieval India');
  ...
  const schema = {
    ...
    "@graph": [
      {
        "@type": "CollectionPage",
        "@id": "https://historyoptional.xyz/pyqs/medieval-india#page",
        "url": "https://historyoptional.xyz/pyqs/medieval-india",
        "name": "Medieval India PYQs — UPSC History Optional",
        "description": questions.length + " Previous Year Questions on Medieval India for UPSC History Optional",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "Medieval India", "item": "https://historyoptional.xyz/pyqs/medieval-india" },
        ]
      }
    ]
  };
    ...
    <>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '2.5rem 1.5rem 5rem' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '2rem', fontWeight: 700, color: 'var(--text)', marginBottom: '0.5rem' }}>
          Medieval India — Previous Year Questions
        </h1>
