...
export default function PYQDetailPage() {
  ...
  const accentClr = isP1 ? 'var(--accent)' : 'var(--blue, var(--accent))';
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
          {[
            ...
            <span key={i} style={{
              background: i === 0 ? (isP1 ? 'var(--accent-dim)' : 'color-mix(in srgb, var(--accent) 12%, transparent)') : 'var(--bg3)',
              color: i === 0 ? accentClr : 'var(--text3)',
              border: `1px solid ${i === 0 ? (isP1 ? 'color-mix(in srgb, var(--accent) 30%, transparent)' : 'color-mix(in srgb, var(--accent) 30%, transparent)') : 'var(--border)'}`,
        ...
        {attemptedReady && (
          <button
            ...
            style={{
              ...
              background: isAttempted(pyq.id) ? 'var(--success-wash)' : 'transparent',
              border: `1px solid ${isAttempted(pyq.id) ? 'color-mix(in srgb, var(--success-text) 45%, transparent)' : 'var(--border)'}`,
              color: isAttempted(pyq.id) ? 'var(--success-text)' : 'var(--text2)',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
            {topperCopies.map(tc => (
              ...
              >
                ...
                <div style={{ color: 'color-mix(in srgb, var(--accent) 80%, transparent)', fontSize: '0.7rem', fontFamily: 'var(--font-mono)', marginTop: '0.4rem' }}>
                  View Copy →
                </div>
              </div>
            ))}
