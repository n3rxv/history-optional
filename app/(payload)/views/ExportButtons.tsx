...
const EXPORTS = [
  { id: 'notes', label: 'Notes',
    desc: 'Every note in the CMS, with its section, paper and content.',
    ...
    <>
      ...
      {EXPORTS.map(x => (
        <div className="ops-row" key={x.id}>
          <div className="ops-row-text"><b>{x.label}</b><span>{x.desc}</span></div>
          <Button
