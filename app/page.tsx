...
const features = [
  ...
  { icon: '🤖', title: 'Personalized AI Assistant',        color: 'var(--green)',  desc: 'An AI that knows your syllabus — ask any History Optional question and get structured, exam-ready answers with historiography. 5 queries/month for free.',            href: '/chat'     },
];
