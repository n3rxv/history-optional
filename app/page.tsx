...
const features = [
  ...
  { icon: '📝', title: 'Answer Evaluation',          color: 'var(--red)',    desc: 'Get your UPSC answers evaluated instantly — detailed feedback, structure & scoring. 1 answer evalution/week for free.' },
    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 1.5rem 4rem' }}>
      ...
      <section style={{ padding: '5rem 0 3.5rem', textAlign: 'center' }}>
        ...
        <p style={{
          ...
          Complete notes · PYQ bank · Answer Evaluation · AI assistant · Interactive timelines — everything History Optional for free at one place.
        </p>
