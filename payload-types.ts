...
export interface Note {
  ...
  title: string;
  /**
   * Must match the slug in lib/notes.ts so the site can find it.
   */
  slug: string;
  section: 'Ancient India' | 'Medieval India' | 'Modern India' | 'World History';
  paper: '1' | '2';
  /**
  ...
  subtopics?:
    ...
    | null;
  /**
   * English body. This is what most readers see.
   */
  content?: {
    root: {
      type: string;
  ...
  /**
   * Hindi body. Leave empty to fall back to English.
   */
  contentHi?: {
    root: {
      type: string;
