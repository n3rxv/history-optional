...
export default function Navbar() {
  ...
  return (
    <>
      <nav style={{ position: 'fixed', top: 33, left: 0, right: 0, zIndex: 1100, background: 'rgba(0,0,0,0.92)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
