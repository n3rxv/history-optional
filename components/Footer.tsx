    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href="/contact?tab=bug" style={linkStyle} onMouseEnter={hoverIn} onMouseLeave={hoverOut}>Report a Bug</Link>
          <Link href="/contact?tab=feature" style={linkStyle} onMouseEnter={hoverIn} onMouseLeave={hoverOut}>Request a Feature</Link>
          <a
      ...
      <div style={{
        ...
        <Link href="/terms" style={linkStyle} onMouseEnter={hoverIn} onMouseLeave={hoverOut}>Terms of Service</Link>
        <Link href="/refund" style={linkStyle} onMouseEnter={hoverIn} onMouseLeave={hoverOut}>Refund Policy</Link>
        <a href="mailto:historyoptional.xyz@gmail.com" style={linkStyle} onMouseEnter={hoverIn} onMouseLeave={hoverOut}>
          historyoptional.xyz@gmail.com
        </a>
      </div>
    </footer>
  );
